...
return [
    ...
    'member' => [
        'title' => 'قواعد صندوق',
        'heading' => 'قواعد صندوق',
        'intro' => 'قواعدی که در حال حاضر بر عملیات جدید حاکم هستند. وام‌ها و آورده‌هایی که پیش‌تر داشته‌اید همان قواعدی را که تحت آن ایجاد شده‌اند حفظ می‌کنند.',
        'no_active_policy' => 'این صندوق سیاست مالی فعالی ندارد. عملیات مالی جدید تا زمانی که یک مدیر صندوق سیاستی منتشر کند، رد می‌شوند.',
        'framework_drift_heading' => 'قواعد این صندوق از چارچوب مالی انتخابی آن مغایرت دارند:',
        'active_since' => 'سیاست مالی نسخهٔ :version، فعال از',
    ],
